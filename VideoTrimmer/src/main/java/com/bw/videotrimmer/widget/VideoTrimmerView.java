package com.bw.videotrimmer.widget;
...
import com.bw.videotrimmer.features.trim.VideoTrimmerUtil;
import com.bw.videotrimmer.R;
import com.bw.videotrimmer.features.trim.VideoTrimmerAdapter;
import com.bw.videotrimmer.interfaces.IVideoTrimmerView;
import com.bw.videotrimmer.interfaces.VideoTrimListener;
import com.bw.videotrimmer.utils.StorageUtil;
...
public class VideoTrimmerView extends FrameLayout implements IVideoTrimmerView {
  ...
  private void initRangeSeekBarView() {
    ...
    if(mThumbsTotalCount - VideoTrimmerUtil.MAX_COUNT_RANGE>0) {
      mAverageMsPx = (mDuration - VideoTrimmerUtil.MAX_SHOOT_DURATION) / (float) (mThumbsTotalCount - VideoTrimmerUtil.MAX_COUNT_RANGE);
    }else{
      mAverageMsPx = 0f;
    }
